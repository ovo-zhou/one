import { getAgentPrompt as getAgentPromptFromDB, createAgentPrompt as createAgentPromptInDB, deleteAgentPrompt as deleteAgentPromptInDB, updateAgentPrompt as updateAgentPromptInDB } from "database";
...
export async function updateAgentPrompt(data: IAgentPrompt) {
  const res = await updateAgentPromptInDB(data);
  return res;
}